...
entity recop_top is
    port (
        ...
        -- This lets a wrapper decode addresses such as 0x3000-0x3007
        -- without moving the internal data RAM out of the datapath.
...
begin
    ...
    u_datapath : entity work.datapath
        port map (
            ...
            dm_ext_addr   => dm_ext_addr,
            dm_ext_wdata  => dm_ext_wdata,
            dm_ext_rdata  => dm_ext_rdata,
            dm_ext_wren   => dm_ext_wren,
