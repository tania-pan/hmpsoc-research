...
DONE:
    ; Return to the polling loop so another KEY1 press can send a new
    ; configuration packet. The wrapper edge-detects KEY1, so holding
    ; the button does not continuously retrigger.
    JMP WAIT_BUTTON
