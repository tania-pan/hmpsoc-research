...
vcom -93 -work work {C:/Users/llat663/Downloads/moving-average-filter/moving_average_asp.vhd}

vcom -93 -work work {C:/Users/llat663/Downloads/moving-average-filter/tb_moving_average_asp.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L rtl_work -L work -voptargs="+acc"  tb_moving_average_asp
